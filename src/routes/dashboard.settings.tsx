...
function SettingsComponent() {
  return (
    <DashboardLayout
      ...
      subtitle="Personalize your learning experience and manage your offline data preferences."
    >
            ...
            <CardContent className="p-6 space-y-8">
              <div className="flex flex-col sm:flex-row items-center gap-8">
                <div className="relative group">
                  ...
                  <Button
                    size="icon"
                    className="absolute bottom-0 right-0 h-9 w-9 rounded-full bg-primary border-4 border-background shadow-lg hover:scale-110 transition-transform"
                  >
                ...
                <div className="space-y-4 flex-1 w-full">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        defaultValue="STUD-KP-2024-089"
                        disabled
                        className="h-10 bg-muted/10 opacity-70"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      defaultValue="I am passionate about ICT and Networking. Aiming for CCNA certification."
              ...
              <div className="grid sm:grid-cols-2 gap-6 pt-4 border-t border-border/40">
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-semibold p-3 rounded-lg bg-muted/50 border border-border/50">
                    Kisumu Polytechnic
                  </p>
                </div>
                <div className="space-y-2">
          ...
          <Card className="border-border/60 shadow-soft bg-background">
            <CardHeader className="p-6 border-b border-border/40">
              <CardTitle className="text-xl flex items-center gap-2">
                <WifiOff className="w-5 h-5 text-accent" /> Offline & Storage
              </CardTitle>
              <CardDescription>
                Configure how your device manages cached educational content.
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Automatically download the next 3 lessons in your active courses when on Wi-Fi.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Saves storage space by downloading 480p instead of 720p/1080p.
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-border/40">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-mono text-xs text-muted-foreground">
                    1.6 GB used of 5.0 GB
                  </span>
                </div>
                <Progress value={32} className="h-2 bg-muted" indicatorClassName="bg-primary" />
                ...
                <div className="p-6 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Last synced: 10 minutes ago via Campus Hotspot
                      </p>
                    </div>
                  </div>
