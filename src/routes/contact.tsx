...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with the JifunzeHub team. Institution inquiries, partnerships and support." },
    ],
  }),
      ...
      <section className="container mx-auto px-4 py-16">
          ...
          <Card className="border-border/60">
            <CardContent className="p-6">
              <Tabs defaultValue="general">
                ...
                <TabsContent value="general"><ContactForm kind="general" /></TabsContent>
                <TabsContent value="institution"><ContactForm kind="institution" /></TabsContent>
              </Tabs>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mx-auto mt-20 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="space-y-2">
            {[
              ["Does JifunzeHub work without internet?", "Yes. The platform is offline-first. Lessons, assessments and progress all work locally. Sync happens silently when connectivity is available."],
              ["What devices are supported?", "Low-end Android phones, tablets, Chromebooks, Windows lab computers and shared kiosks."],
              ["How do you deliver content to remote campuses?", "Three ways: local campus server over LAN/Wi-Fi hotspot, USB content packages, or direct internet sync."],
              ["Is JifunzeHub aligned with TVET frameworks?", "Yes. Courses are organised around competencies, practicals, and assessments matching national TVET standards."],
            ].map(([q, a]) => (
