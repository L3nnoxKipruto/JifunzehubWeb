      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 bg-gradient-to-br from-primary/10 via-background to-accent/5 p-6 rounded-2xl border border-primary/10 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-3 z-10 w-full md:w-auto mt-4 md:mt-0">
            ...
            <Button
              variant="outline"
              className="bg-background/50 backdrop-blur border-border/60 hover:bg-muted flex-1 md:flex-none"
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Card className="group overflow-hidden border-border/60 hover:shadow-elegant hover:border-primary/30 transition-all duration-300 flex flex-col">
                  <div className="relative h-32 bg-muted overflow-hidden">
                    ...
                    />
                    <Badge className="absolute top-3 left-3 z-20 bg-background/80 text-foreground backdrop-blur border-none font-semibold">
                      ICT Dept
                    </Badge>
                    <Badge
                      variant="outline"
                      className="absolute top-3 right-3 z-20 bg-success/90 text-success-foreground border-none backdrop-blur font-semibold"
                    >
                      Available Offline
                    </Badge>
                    <div className="absolute bottom-3 left-3 z-20 w-full pr-6">
                      ...
                      <p className="text-xs text-white/80 mt-1 line-clamp-1">
                        Module 4: Subnetting Architectures
                      </p>
                    </div>
                  </div>
                  <CardContent className="p-4 flex-1">
                    ...
                    <Progress value={64} className="h-2 bg-muted" indicatorClassName="bg-primary" />
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center gap-2">
                        <Avatar className="w-6 h-6 border">
                          <AvatarFallback className="text-[10px]">EK</AvatarFallback>
                        </Avatar>
                        <span className="text-xs text-muted-foreground">Eng. Kamau</span>
                      </div>
                      <span className="text-xs font-medium text-muted-foreground flex items-center">
                        <Clock className="w-3 h-3 mr-1" /> 45m left
                      </span>
                    </div>
                  </CardContent>
                  <CardFooter className="p-4 pt-0 gap-2 border-t border-border/40 mt-auto bg-muted/10">
                    <Button className="flex-1 w-full bg-primary/10 text-primary hover:bg-primary/20">
                ...
                <Card className="group overflow-hidden border-border/60 hover:shadow-elegant hover:border-primary/30 transition-all duration-300 flex flex-col">
                  <div className="relative h-32 bg-muted overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
                    <img
                      src="https://images.unsplash.com/photo-1498084393753-b411b2d26b34?w=800&q=80"
                      alt="Programming"
                      className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500"
                    />
                    <Badge className="absolute top-3 left-3 z-20 bg-background/80 text-foreground backdrop-blur border-none font-semibold">
                  ...
                  <CardContent className="p-4 flex-1">
                    ...
                    <Progress value={12} className="h-2 bg-muted" indicatorClassName="bg-primary" />
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center gap-2">
                        <Avatar className="w-6 h-6 border">
                          <AvatarFallback className="text-[10px]">SW</AvatarFallback>
                        </Avatar>
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4 relative">
                      ...
                      <div className="flex-1 pb-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Networking Essentials • Scored 92%
                        </p>
                        <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider block mt-2">
                          2 hours ago
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 relative">
                      ...
                      <div className="flex-1 pb-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Python Intro (Modules 1-3) saved to local cache
                        </p>
                        <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider block mt-2">
                          Yesterday, via Campus LAN
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 relative">
                      ...
                      <div className="flex-1 pb-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Subnetting Lab Worksheet submitted offline
                        </p>
                        <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider block mt-2">
                          Yesterday
                        </span>
                ...
                <div className="divide-y divide-border/50">
                  <div className="p-4 hover:bg-muted/30 transition-colors">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge
                        variant="destructive"
                        className="bg-destructive/15 text-destructive border-none text-[10px]"
                      >
                        Due Today
                      </Badge>
                    </div>
                  ...
                  <div className="p-4 hover:bg-muted/30 transition-colors">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge
                        variant="outline"
                        className="text-[10px] bg-amber-500/10 text-amber-600 border-none"
                      >
                        In 2 Days
                      </Badge>
                    </div>
            ...
            <Card className="border-accent/20 bg-accent/5 shadow-inner">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex items-center gap-2 text-accent-foreground">
                  <Lightbulb className="w-4 h-4 text-accent fill-accent/20" /> Smart Suggestions
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="bg-background rounded-lg p-3 border border-border/60 shadow-sm flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground mt-1">
                      You're almost done with Networking M4. Download M5 now while you have LAN
                      access.
                    </p>
                  </div>
                </div>
                <div className="bg-background rounded-lg p-3 border border-border/60 shadow-sm flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground mt-1">
                      You spent extra time on question 4 in your last quiz. Reviewing this topic is
                      recommended.
                    </p>
                  </div>
                </div>
